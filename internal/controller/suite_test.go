...
var _ = BeforeSuite(func() {
	...
	if realClient {
		...
		k8sClient = fake.NewClientBuilder().WithScheme(scheme.Scheme).WithStatusSubresource(&v1alpha1.Postgres{}, &v1alpha1.PostgresUser{}, &v1alpha1.PostgresExternalRole{}).Build()
